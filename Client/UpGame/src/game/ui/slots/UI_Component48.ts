...
module ui.slots {
	...
	export class UI_Component48 extends fairygui.GComponent {
		...
		public static URL:string = "ui://3ly9g3laazd7k6y";

		public static createInstance():UI_Component48 {
			return <UI_Component48><any>(fairygui.UIPackage.createObject("slots","Component48"));
		}
