...
module ui.slots {
	...
	export class UI_Component49 extends fairygui.GComponent {
		...
		public m_n39_2:fairygui.GTextField;
		public m_n40:fairygui.GTextField;

		public static URL:string = "ui://3ly9g3laazd7k6z";

		public static createInstance():UI_Component49 {
			return <UI_Component49><any>(fairygui.UIPackage.createObject("slots","Component49"));
		}
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_n39_2 = <fairygui.GTextField><any>(this.getChild("n39"));
