...
module starlingswf{
    ...
    export class Swf{
        ...
        public addUpdateEventListener(){
            egret.Ticker.getInstance().register(this.swfUpdateManager.update,this.swfUpdateManager);
        }

        public removeUpdateEventListener(){
            egret.Ticker.getInstance().unregister(this.swfUpdateManager.update,this.swfUpdateManager);

        }

        public clearUpdateQueue(){
            this.swfUpdateManager.clearQueue(this.swfUpdateManager);
        }
