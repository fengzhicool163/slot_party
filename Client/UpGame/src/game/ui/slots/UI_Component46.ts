...
module ui.slots {
	...
	export class UI_Component46 extends fairygui.GComponent {
		...
		public static URL:string = "ui://3ly9g3laazd7k6w";

		public static createInstance():UI_Component46 {
			return <UI_Component46><any>(fairygui.UIPackage.createObject("slots","Component46"));
		}
